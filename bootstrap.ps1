...
#  its whole job is to get the user signed in to GitHub, fetch the private
#  repository and hand over to install.ps1.
#
#  There is no activation key here. Access to the private repository IS the
#  gate: an account has to be invited, and removing it cuts off updates. A
#  second code on top of that only added a step for the person installing.
#
#  Run:
